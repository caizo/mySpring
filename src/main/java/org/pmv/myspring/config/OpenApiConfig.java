...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        SecurityRequirement requerimientosDeSeguridad = new SecurityRequirement().addList("Bearer")
                .addList(String.valueOf(new Scopes().addString("global", "access all APIs")));

        return new OpenAPI(SpecVersion.V30)
                .info(apiInfo())
                .externalDocs(new ExternalDocumentation()).servers(servers())
                .security(Collections.singletonList(requerimientosDeSeguridad))
